...
if CLIENT then
	...
	language.Add( "tool.fading_door.desc", "Скрывающаяся дверь" )
	language.Add( "tool.fading_door.0", "Скрывающаяся дверь" )
	language.Add( "Undone_fading_door", "Отмена скрывающей двери" )
